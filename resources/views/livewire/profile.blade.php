        ...
        <div class="container-fluid py-4">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                        ...
                        <form wire:submit.prevent="addBio" action="#" method="POST"
                            ...
                            <div class="row setup-content"
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model.lazy="matric_no"
                                            value="{{ old('matric_no', $applications->matric_no ?? '') }}"
                                            class="form-control" />
                                        @error('matric_no')
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="year_failed_exam">Failed Program Year:</label>
                            ...
                            <div class="row setup-content"
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <div class="form-group ">
                                        <label for="no_of_course">Courses Failed:</label>
                                        <input type="text" wire:model.lazy="no_of_course"
                                            value="{{ old('no_of_course', $applications->no_of_course ?? '') }}"
                                            class="form-control" />
                                        @error('no_of_course')
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" wire:model.lazy="cgpa"
                                            value="{{ old('cgpa', $applications->cgpa ?? '') }}"
                                            class="form-control" />
                                        @error('cgpa')
                                            <div class="text-danger">{{ $message }}
                                            </div>
                        ...
                        @if ($applications)
                            <a href={{route('print')}}
                                class="btn  bg-gradient-light float-start  btn-sm mt-4 mb-4"
                                >Print Form</a>
                        @endif

                            <button
                                class="btn  bg-gradient-dark float-end  btn-sm mt-4 mb-4"
                                id="step-1"  type="submit">Submit</button>
