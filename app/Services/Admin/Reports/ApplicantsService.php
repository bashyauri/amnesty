...
class ApplicantsService
{
    ...
    {
        $applicants = Application::where('department_id', Auth::guard('admin')->user()->department_id)->get();
        ...
        //         'tb_accountcreation.surname',
        //         'tb_accountcreation.firstname',
        //         'tb_accountcreation.m_name',
        //         'tb_accountcreation.p_number'
        //     )
        //     ->get();
